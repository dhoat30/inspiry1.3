...
class GeoDir_Location_AJAX {
	...
	public static function ajax_save_neighbourhood() {
		...
		try {
			...
			$name 				= ! empty( $_POST['neighbourhood_name'] ) ? sanitize_text_field( $_POST['neighbourhood_name'] ) : '';
			$latitude 			= ! empty( $_POST['neighbourhood_latitude'] ) ? sanitize_text_field( $_POST['neighbourhood_latitude'] ) : '';
			$longitude 			= ! empty( $_POST['neighbourhood_longitude'] ) ? sanitize_text_field( $_POST['neighbourhood_longitude'] ) : '';
