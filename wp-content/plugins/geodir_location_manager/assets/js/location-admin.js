jQuery(function($) {
  if ($("input[name=lm_show_switcher_in_nav]").length) {
    $("input[name=lm_show_switcher_in_nav]").click(function() {
  ...
  if ($("input[name=lm_default_country]").length) {
    $("input[name=lm_default_country]").click(function() {
      if ($(this).is(':checked')) {
  ...
  if ($("input[name=lm_default_region]").length) {
    $("input[name=lm_default_region]").click(function() {
      if ($(this).is(':checked')) {
  ...
  if ($("input[name=lm_default_city]").length) {
    $("input[name=lm_default_city]").click(function() {
      if ($(this).is(':checked')) {
  ...
  if ($('#geodir-add-location-div #geodir_save_location_nonce').length) {
    GeoDir_Location.init();
  }

  if ($('#geodir-save-neighbourhood-div #geodir_save_neighbourhood_nonce').length) {
  ...
  if ($(".neighbourhoods .geodir-delete-neighbourhood").length) {
    $(".neighbourhoods .geodir-delete-neighbourhood").click(function(e) {
  ...
  if ($(".cities .geodir-location-set-default").length) {
    $(".cities .geodir-location-set-default").click(function(e) {
...
var GeoDir_Location = {
  init: function() {
    var $self = this;
    this.el = jQuery('#geodir-add-location-div');
    this.form = jQuery('form#mainform');
    this.form.attr('action', 'javascript:void(0);');
    jQuery("#save_location", this.el).on("click", function(e) {
      $self.saveLocation(e);
    });
  },
  block: function() {
    ...
    jQuery.ajax({
      ...
      success: function(res, textStatus, xhr) {
        ...
        if (res && res.data && res.data.message) {
          jQuery('.form-table', $self.el).before('<div class="gd-save-location-message ' + msg_class + '"><p>' + res.data.message + '</p></div>');
        }
        $self.unblock();
...
var GeoDir_Location_Neighbourhood = {
  init: function() {
    var $self = this;
    this.el = jQuery('#geodir-save-neighbourhood-div');
    this.form = jQuery('form#mainform');
    this.form.attr('action', 'javascript:void(0);');
    jQuery("#save_neighbourhood_button", this.el).on("click", function(e) {
  ...
  saveNeighbourhood: function(e) {
    ...
    jQuery.ajax({
      ...
      success: function(res, textStatus, xhr) {
        ...
        if (res && res.data && res.data.message) {
          jQuery('.form-table', $self.el).before('<div class="gd-save-neighbourhood-message ' + msg_class + '"><p>' + res.data.message + '</p></div>');
        }
        $self.unblock();
        jQuery('html, body').animate({
          scrollTop: jQuery("#mainform").offset().top
